...
# Streamlit 界面
st.title("1-year survival of ECLM patients based on Logistic Regression")
...
if st.button("Predict"):
    ...
    st.write(f"Probability of 1-year survival: {prob_survival:.4f}")
    st.write(f"Probability of death within 1-year: {prob_dead:.4f}")
